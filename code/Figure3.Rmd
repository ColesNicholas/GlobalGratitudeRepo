...
mod.DF <-
  (if (file.exists(here("data/final-data", "crossculturalmod.csv"))) {
...
```{r}
ggsave(
  filename = here("figures", "Figure3.pdf"),
  plot = fig.3,
  device = pdf,
  width = 18,
  height = 15,
