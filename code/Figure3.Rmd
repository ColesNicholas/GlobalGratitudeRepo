...
fig.3a <-
  ...
  # vertical line
  geom_segment(x = 52, xend = 52, y = 0.75, yend = 5.25, color = "#3C5488") +
  # top horizontal
  geom_segment(x = 51, xend = 52, y = 5.25, yend = 5.25, color = "#3C5488") +
  # bottom horizontal
  geom_segment(x = 51, xend = 52, y = 0.75, yend = 0.75, color = "#3C5488") +
