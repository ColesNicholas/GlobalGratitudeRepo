...
cohen_label <- 
  ...
  paste0(" = ", estimate, ", 95% CI [", ci_lower, ", ", ci_upper, "]") %>% 
    return()
})
...
x_tau_i <- c(0.02, 0.52, 0.02, 0.52, 0.02, 0.52)
y_tau_i <- c(0.95, 0.95, 0.63, 0.63, 0.31, 0.31)

x_tau_c <- c(0.02, 0.52, 0.02, 0.52, 0.02, 0.52)
...
for(i in seq_along(cohen_label)) {
  p <- p + draw_label(cohen_label[[i]],
