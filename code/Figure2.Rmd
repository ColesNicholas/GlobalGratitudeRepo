...
# Annabel: Calculate country-level and intervention-level descriptives
```{r}
#Annabel: The above code wasn't working for me.
d.c <- df %>% 
  group_by(country) %>% 
  summarise(m = mean(pa_effect_size), .groups = "drop") %>%
