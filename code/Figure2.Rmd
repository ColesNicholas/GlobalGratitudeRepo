...
m.p <- lapply(seq_along(effect_size_columns), function(i) {
  ...
  p <- ggplot(data_subset) +
    ...
    geom_text_repel(
      ...
      color = "#3C5488", alpha = .5, nudge_y = .005, size = 2.5
    ) +
    ...
    geom_text_repel(
      data = subset(data_subset, dataset == "d.all"),
      aes(x = m, y = y, label = label),
      color = "#91505E", alpha = .6, nudge_y = .005, size = 2.5
    ) +
    ...
    geom_text_repel(
      data = subset(data_subset, dataset == "d.i"),
      aes(x = m, y = y, label = label),
      color = "#E64B35", alpha = .5, nudge_y = .005, size = 2.5
    ) +
