...
#English only-test
df_en <- read.csv(file = here("data", "en_unique_country_effect_sizes.csv")) %>% drop_na(pa_effect_size)
...
# m.ic2  <- lapply(1:length(effect_size_columns), function(i) {
#   rma.mv(yi = df[[effect_size_columns[i]]],
#          V = df[[variance_columns[i]]],
#          random = list(~ 1 | intervention_condition/country),
#          data = df)})
